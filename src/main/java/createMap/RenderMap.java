...
public class RenderMap {
	...
	private String getUnicodesForObjects(Entity entity) {
		return selectUnicodeSpriteForObject(entity, GRASS_UNICODE, RABBIT_UNICODE, WOLF_UNICODE, ROCK_UNICODE,
				TREE_UNICODE);
	}

	private String getColorsForObjectsUnikode(Entity entity) {
	...
	private String selectUnicodeSpriteForObject(Entity entity, String chooseGrass, String chooseHerbivore,
			String choosePredator, String chooseRock, String chooseTree) {
	...
	private String getEntitySprite(Entity entity) {
		String objectUnicodes = getUnicodesForObjects(entity);
		String ansiColors = getColorsForObjectsUnikode(entity);
		return colorizeSprite(ansiColors + objectUnicodes);
	}

	private String colorizeSprite(String sprite) {
		return ANSI_SQUARE_BACKGROUND + sprite + ANSI_RESET;
	}
